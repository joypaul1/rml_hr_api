...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!$validator->validateRequired($requiredFields)) {
        ...
        $user_password  = $validator->get('user_password');
        ...
        WHERE 
            ...
            if ($objResultFound) {
                ...
                $jsonData = ["status" => true,  "data" => $responseData, "message" =>'Succfully Data Found.'];
            ...
            // $jsonData = ["status" => "false", "message" => "An error occurred. Please try again later."];
